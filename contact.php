...
if (isWasteString($message)){
  $finalmessage="Please enter a message";
}
elseif (!captchapass($captcharesponse)){
  ...
  $message = !isWasteString($revised_post_array["message2"]) ? clean_string($revised_post_array["message2"]) : "Sorry! This person sent an empty message :(";
...
<html>
  ...
  <body>
    <p>$finalmessage</p>
    <a href="/">Go back to the campaign page</a>
  </body>
</html>
EOT;
?>
